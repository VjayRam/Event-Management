...
public class UserInterface_GUI extends JFrame implements ActionListener
{
    ...
    public UserInterface_GUI(Controller_GUI rController)
    {
        ...
        mainPanel.add("HostList", cEmployeeListPanel);
        cEditEmployeePanel = new EditEmployeePanel();
        mainPanel.add("EditHost", cEditEmployeePanel);
    ...
    private void createMasterPanelConpornents()
    {
        ...
        headTitle = new JLabel("Event Management System");
        ...
        mainBtnShowMenu = new JButton("Event List");
        ...
        mainBtnManageEmployee = new JButton("Manage Host");
        mainBtnManageEmployee.addActionListener(this);
        mainBtnsPanel.add(mainBtnManageEmployee);
        
        mainBtnManageMenuItem = new JButton("Manage Events");
    ...
    *****************************************************************/       
    private class MenuListPanel extends JPanel implements ActionListener
    {
        ...
        private JButton         btnConcert;
        private JButton         btnComedy;
        ...
        public MenuListPanel()
        {
           ...
           btnMain = new JButton("Movie");
           btnMain.addActionListener(this);
           btnConcert = new JButton("Concert");
           btnConcert.addActionListener(this);
           btnComedy = new JButton("Comedy");
           btnComedy.addActionListener(this);
           btnDessert = new JButton("Drama");
           btnDessert.addActionListener(this);
           
           btnPanel.add(btnAll);
           btnPanel.add(btnMain);
           btnPanel.add(btnConcert);
           btnPanel.add(btnComedy);
        ...
        public void actionPerformed(ActionEvent ae) {
            ...
            {
                showMenuList(MenuItem.MOVIE);
                //showParticularMenuList(MenuItem.MOVIE, displayArea);
            }
            else if (ae.getSource() == btnConcert)
            {
                showMenuList(MenuItem.CONCERT);
                //showParticularMenuList(MenuItem.DRINK, displayArea);
            }
            else if (ae.getSource() == btnComedy)
            {
                showMenuList(MenuItem.COMEDY);
                //showParticularMenuList(MenuItem.COMEDY, displayArea);
            }
            else if (ae.getSource() == btnDessert)
            {
                showMenuList(MenuItem.DRAMA);
                //showParticularMenuList(MenuItem.DRAMA, displayArea);
            }
        }
    }
    ...
    *****************************************************************/    
    private class MenuManagementPanel extends JPanel implements ActionListener
    {
        ...
        public MenuManagementPanel()
        {
            ...
            btnAddNewMenuItem     = new JButton("Add new event");
            ...
            btnEditMenuItem    = new JButton("Edit event");
            ...
            btnDeleteMenuItem   = new JButton("Delete event");
    ...
    *****************************************************************/       
    private class EditMenuItemPanel extends JPanel implements ActionListener
    {
        ...
        public EditMenuItemPanel()
        {
            ...
            lblMenuItemID = new JLabel("Event ID:");
            ...
            String[] combodata = {"Movie", "Concert", "Comedy", "Drama"};
        ...
        public void init(int menuItemID)
        {
            ...
            switch( rMenuItem.getType())
            {
                case MenuItem.MOVIE:
                    setType("Movie");
                break;
                case MenuItem.CONCERT:
                    setType("Concert");
                break;
                case MenuItem.COMEDY:
                    setType("Comedy");
                break;
                case MenuItem.DRAMA:
                    setType("Drama");
        ...
        public void actionPerformed(ActionEvent ae) {
            if (ae.getSource() == btnOK)
            {
                ...
                if( strMenuType.equals("Movie"))
                {
                    menuType = MenuItem.MOVIE;
                }
                else if( strMenuType.equals("Concert"))
                {
                    menuType = MenuItem.CONCERT;
                }
                else if( strMenuType.equals("Comedy"))
                {
                    menuType = MenuItem.COMEDY;
                }
                else    //Dessert
                {
                    menuType = MenuItem.DRAMA;
                }
                
                if(isUpdate)
                {
                    if(! rcController.updateMenuItem(menuItemID , tbName.getText(), Double.parseDouble(tbPrice.getText()), menuType, tbDescription.getText()))
                    {
                        showErrorDialog("Error", rcController.getErrorMessage());
                        return;
                    }
                ...
                {                   
                    if(! rcController.addNewMenuItem(menuItemID , tbName.getText(), Double.parseDouble(tbPrice.getText()), menuType, tbDescription.getText()))
                    {
                        showErrorDialog("Error", rcController.getErrorMessage());
                        return;
                    }
                    showConfirmDialog("Message", "New Event is added!!");
                }
                init(menuItemID);
            }
        }
    ...
    *****************************************************************/       
    private class OrderDetailPanel extends JPanel implements ActionListener, ListSelectionListener
    {
        ...
        public OrderDetailPanel()
        {
            ...
            gbc.gridx = 2;
            gbc.gridy = 2;
            gbLayout.setConstraints(btnConcert, gbc);
            menuListPanel.add(btnConcert);
            
             btnComedy  = new JButton("Comedy");
             btnComedy.addActionListener(this);
            gbc.gridx = 3;
            gbc.gridy = 2;
            gbLayout.setConstraints(btnComedy, gbc);
            menuListPanel.add(btnComedy);
        ...
        public void actionPerformed(ActionEvent ae) {
            ...
            {
                //createParticularMenuList(MenuItem.MOVIE, menuList);
                menuList.setListData(rcController.createMenuList(MenuItem.MOVIE).toArray());
                menuScrollPanel.getViewport().setView(menuList);
            }
             else if (ae.getSource() == btnConcert)
            {
                //createParticularMenuList(MenuItem.CONCERT, menuList);
                menuList.setListData(rcController.createMenuList(MenuItem.CONCERT).toArray());
                menuScrollPanel.getViewport().setView(menuList);
            }
             else if (ae.getSource() == btnComedy)
            {
                //createParticularMenuList(MenuItem.COMEDY, menuList);
                menuList.setListData(rcController.createMenuList(MenuItem.COMEDY).toArray());
                menuScrollPanel.getViewport().setView(menuList);
            }
             else if (ae.getSource() == btnDessert)
            {
                //createParticularMenuList(MenuItem.DRAMA, menuList);
                menuList.setListData(rcController.createMenuList(MenuItem.DRAMA).toArray());
                menuScrollPanel.getViewport().setView(menuList);
            }
        }
