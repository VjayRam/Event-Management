...
{
    public final static String STAFF_FILE = "C:\\Users\\vjayr\\Downloads\\EventManagement-Final\\EventManagement\\src\\dataFiles\\staff.txt";
    public final static String MANAGER_FILE = "C:\\Users\\vjayr\\Downloads\\EventManagement-Final\\EventManagement\\src\\dataFiles\\manager.txt";
    public final static String MENU_FILE = "C:\\Users\\vjayr\\Downloads\\EventManagement-Final\\EventManagement\\src\\dataFiles\\menu_item.txt";
    public final static String REPORT_FILE = "C:\\Users\\vjayr\\Downloads\\EventManagement-Final\\EventManagement\\src\\dataFiles\\reports\\report_2023_04_22.txt";
     ...
     ***************************************************************************/
     ...
     public void editMenuItemData(int id, String newName, double newPrice, byte menuType, String newDescription) throws DatabaseException
     {
         MenuItem rMenuItem = findMenuItemByID(id);
         rMenuItem.setName(newName);
         rMenuItem.setPrice(newPrice);
         rMenuItem.setType(menuType);
         rMenuItem.setDescription(newDescription);
         ...
         try
         {
             switch(which)
             {
                 ...
                 case EDIT_ITEM_TYPE:
                    ...
                    if(newType < MenuItem.MOVIE || MenuItem.DRAMA < newType)
                        throw new DatabaseException("Type must be between " + MenuItem.MOVIE
                                            + " and " + MenuItem.DRAMA + ")");
                    else
     ...
     public void addMenuItem(int newID, String newName, double newPrice, byte newType, String newDesc) throws DatabaseException
     {
         MenuItem newMenuItem = new MenuItem(newID, newName,newPrice, newType, newDesc);
    ...
    private void loadMenuFile() throws DatabaseException
    {
        try {
            ...
            while (line != null) {
                ...
                // Add the data from file to the registerCourses array list
                MenuItem rMenuItem = new MenuItem(Integer.parseInt(id), name, Double.parseDouble(price), Byte.parseByte(type), desc);
    ...
    ***************************************************************************/
    public void updateStaffFile(boolean isManager) throws DatabaseException
    {
        ...
        String          line;
        String          fileName;
        String          tempFileName = "F:\\sem6\\ooad\\ooad_cafemgmt\\src\\dataFiles\\dataFiles\\temp.txt";
    ...
    public void updateMenuFile() throws DatabaseException
    {
        ...
        try{
            ...
            while (it.hasNext())
            {
                ...
                writer.write(re.getID() + "," + re.getName() + "," + re.getPrice() + "," + re.getType()+ "," + re.getDescription() + "\r\n");
            }
            writer.flush();
            writer.close();
        }
