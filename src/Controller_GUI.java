...
public class Controller_GUI
{
     ...
     * Menu management
     **********************************************************/
    public boolean addNewMenuItem(int newID, String newName, double newPrice, byte menuType, String desc)
    {
        ...
        try
        {
            cDatabase.addMenuItem(newID, newName, newPrice, menuType, desc);
            return true;
        }
        catch(DatabaseException de)
        {
    ...
    public boolean updateMenuItem(int id, String newName, double newPrice, byte menuType, String desc)
    {
        try
        {
            cDatabase.editMenuItemData(id, newName, newPrice, menuType, desc);
            return true;
        }
        catch(DatabaseException de)
        {
    ...
    public ArrayList<String> createMenuList(int disuplayMenuType)
    {
        ...
        while (it.hasNext()) {
            ...
            String output = String.format("MenuID:%4d    Name:%-20s    Price:%5.2f    Type:%s    Description:%s",
                                            re.getID(),re.getName(),re.getPrice(),strMenuType,re.getDescription());
